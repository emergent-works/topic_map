...
class TopicMapBlock extends BlockBase {
  ...
  public function build() {
    ...
    $sql = "select concat(`entity_id`,'p',`field_topicmap_parents_target_id`) AS `id`,`entity_id` AS `source`,`field_topicmap_parents_target_id` AS `target`,'parent' AS `relation` from `taxonomy_term__field_topicmap_parents` where bundle = '" . $block_id . "' union select concat(`taxonomy_term__field_topicmap_neighbours`.`entity_id`,'n',`taxonomy_term__field_topicmap_neighbours`.`field_topicmap_neighbours_target_id`) AS `id`, `entity_id` AS `source`, `field_topicmap_neighbours_target_id` AS `target`,'neighbour' AS `relation` from `taxonomy_term__field_topicmap_neighbours` where entity_id > field_topicmap_neighbours_target_id and bundle = '" . $block_id . "'";
